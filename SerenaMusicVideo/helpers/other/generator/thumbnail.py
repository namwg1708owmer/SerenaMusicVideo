...
async def gen_thumb(thumbnail, title, userid, ctitle):
    ...
    font = ImageFont.truetype("SerenaMusicVideo/helpers/other/choose/Roboto-Light.ttf", 55)
    font2 = ImageFont.truetype("SerenaMusicVideo/helpers/other/choose/finalfont.ttf", 65)
    draw.text(
        (20, 630),
        f"{title[:25]}...",
        fill="White",
